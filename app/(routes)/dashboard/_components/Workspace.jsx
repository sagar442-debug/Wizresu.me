...
function Workspace() {
  return (
    <div className="">
      <h2 className="text-2xl mx-1 ">Hello Sagar</h2>
      ...
      <Link
        href={"/dashboard/create-new-resume"}
        className=" flex items-center border w-64 h-40  rounded-2xl mt-10 shadow-lg cursor-pointer hover:bg-gray-50 transition-all"
      >
